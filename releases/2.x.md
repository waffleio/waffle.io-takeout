...
- New account page giving an overview of a users Waffle account.
...
#### Bug Fixes
- No longer manditory to specify a GitHub.com client id and client secret in the console settings.
