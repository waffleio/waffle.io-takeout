...
## Waffle Takeout 2.6.0
_Released 2016.11.30_

#### Features
- Release WaffleMetrics to Takeout customers

# Waffle Takeout 2.5

## Waffle Takeout 2.5.0
_Released 2016.09.26_

#### Chore
- Improves docker images
  - Brings in more consistency in our images
- Updates our poxa image to latest

# Waffle Takeout 2.4

## Waffle Takeout 2.4.9
_Released 2016.09.20_

_Supported GH:E versions: GH:E 2.2+_

#### Bug Fixes
- Restoring Waffle data during snapshot is fixed. There is a manual step involved. Please refer to our [documentation](https://github.com/waffleio/waffle.io-takeout/blob/master/INSTALL.md#backups).

## Waffle Takeout 2.4.8
...
## Waffle Takeout 2.4.7
_Released 2016.08.29_

_Supported GH:E versions: GH:E 2.2+_

#### Bug Fixes
- When migrating an existing database, publish the packaged MongoDB instance port to 27018 to avoid collisions with existing MongoDB instances running on the default 27017 port.
