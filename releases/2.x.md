...
#### Features
- When upgrading from a Takeout 1.x instance, there is now an option in the Admin Console under "Settings" > "Migrate your database from an older Takeout installation" which allows you specify an existing MongoDB connection string to migrate your existing data into a packaged MongoDB instance.
