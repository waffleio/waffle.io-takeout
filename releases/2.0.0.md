...
#### New Features
- The 2.0 release train is delivered via [Replicated](../doc/REPLICATED.md). If you're on a 1.x version or earlier that was self-installed with docker images, we'll support upgrading to 2.0 soon. Updates to the 1.x train will continue until the upgrade path is supported.
